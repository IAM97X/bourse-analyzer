...
━━━ FORMAT JSON STRICT ━━━
{"decisions":[{"action":"BUY","ticker":"MC.PA","nom":"LVMH","quantite":2,"cours":650.5,"raison":"..."},{"action":"HOLD","ticker":"AIR.PA","nom":"Airbus","quantite":0,"cours":160.0,"raison":"..."}],"strategie":"1-2 phrases raisonnement macro","conviction":"fort"}

conviction DOIT être : "faible" (observation, pas de BUY), "moyen" (signal présent mais incertain, pas de BUY), ou "fort" (signal clair, BUY autorisé). Les SELL s'exécutent toujours indépendamment de la conviction.`;

  const body = {
    systemInstruction: {
      parts: [{ text: "Tu es un gestionnaire de portefeuille IA autonome gérant un portefeuille réel (PEA ou CTO). Tu analyses 2 fois par jour (ouverture 9h05, clôture 17h15) et tu passes à l'action uniquement quand tu as une conviction forte. Tu hérites des positions et liquidités réelles de l'investisseur et tu prends le relais de façon totalement autonome. OBJECTIF PRINCIPAL : battre le marché (CAC40 / MSCI World selon le compte) ET surperformer le portefeuille réel de l'investisseur humain sur le long terme. Tu as accès au portefeuille réel, aux signaux marché, aux transactions passées et au profil de l'investisseur — utilise tout cela pour prendre de meilleures décisions que lui. Tu respectes strictement les contraintes du courtier (minimums, frais, pas de fractionné). Tu raisonnes comme un professionnel : analyse macro, momentum, rotation sectorielle, gestion du drawdown, protection du capital en marché baissier. Tu es discipliné, rationnel, sans émotions. Tu analyses et agis uniquement lors des cycles prévus (ouverture et clôture). À chaque cycle, tu prends toutes les décisions que tu juges pertinentes (BUY, SELL, HOLD) selon ta conviction et les opportunités — sans limite artificielle sur le nombre d'achats. Tu respectes les contraintes du courtier et du portefeuille. Over-trading inutile détruit la performance : ne trade que si le signal justifie l'action. Chaque décision est justifiée en une phrase précise et factuelle." }]
    },
