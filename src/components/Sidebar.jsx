      ...
      {!mobileCompact && <div className="ba-sidebar-logo" style={{ padding: "18px 14px 16px", borderBottom: `1px solid ${C.sbBorder}`, display: "flex", alignItems: "center", gap: "10px", flexShrink: 0, justifyContent: c ? "center" : "flex-start" }}>
        {isMobile
          ? <div style={{ display: "flex", alignItems: "center", gap: "10px", flex: 1 }}>
              <AppLogo size={30} />
              <div style={{ flex: 1 }}>
                <div style={{ fontSize: "14px", fontWeight: "800", color: C.ink, letterSpacing: "-0.03em" }}>Orivo</div>
              </div>
          ...
          : <>
              ...
              {!c && <div>
                <div style={{ fontSize: "13px", fontWeight: "800", color: C.ink, letterSpacing: "-0.03em" }}>Orivo</div>
              </div>}
            </>
        }
      </div>}
